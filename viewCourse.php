                                ...
                                <tbody>
                                    ...
                                    foreach($courses as $course) { ?>
                                        <tr>
                                            ...
                                            <td>
                                            <button class="btn btn-info" data-toggle="modal" data-target="#editCourseModal<?=$course['CourseID']?>"><i class="nav-icon fas fa-edit"></i> </button>
                                                <button class="btn btn-danger"><a href="process.php?coz_del=<?=$course['CourseID']?>"><i class="nav-icon fas fa-trash"></i></a></button>
                                            </td>
                                        </tr>

                                        <!-- Edit Course Modal -->
                                        <div class="modal fade" id="editCourseModal<?=$course['CourseID']?>" tabindex="-1" role="dialog" aria-labelledby="editCourseModalLabel" aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="process.php?updateID=<?=$course['CourseID']?>" method="POST">
                                                            <input type="hidden" name="courseID" value="<?=$course['CourseID']?>">
                                                            <div class="form-group">
                                                                <label for="course_name">Course Name</label>
                                                                <input type="text" class="form-control" name="course_name" value="<?=$course['CourseName']?>" required>
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="department_id">Department ID</label>
                                                                <input type="text" class="form-control" name="department_id" value="<?=$course['DepartmentID']?>" required>
                                                            </div>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form action="process.php" method="POST">
                                        <!-- Add your form inputs for adding a new course here -->
                                        <div class="form-group">
