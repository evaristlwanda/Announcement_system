...
//select data from joining table
// $query = "
...
//     JOIN teachers As t ON u.UserID = t.UserID WHERE PostedBy= '$teacher_id' ORDER BY PostedDate DESC ";
//     $announces = mysqli_query($conn, $query);
            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    ...
                    <?php if ($_SESSION['RoleID'] == 1): ?>
                        ...
                        <li class="nav-item">
                            <a href="post_announcement.php" class="nav-link active">
                            ...
                            <div class="card">
                                <div class="card-header p-2">
                                    <ul class="nav nav-pills">
                                        <li class="nav-item"><a class="nav-link active" href="#upload" data-toggle="tab">Upload Announcement</a></li>
                                    </ul>
                                </div><!-- /.card-header -->
                                <div class="card-body">
                                        ...
                                        <div class="active tab-pane" id="upload">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <label for="category">Category:</label>
                                                   ...
                                                   <?php foreach($annCategories as $category){ ?>
                                                     <option value="<?=$category['CategoryID']?>"><?=$category['CategoryName']?></option>
                                                     <?php } ?>
                                                   </select><br>

                                            <div class="form-group">
                                                    <label for="announcementFile">Upload Attachment (PDF, Image, etc.):</label>
                                                    <input type="file" class="form-control-file" id="announcementFile" name="announcementFile" accept=".pdf,.jpg,.jpeg,.png,.docx,.xlsx" required>
                                                </div>

                                                <button type="submit" name="announcement" class="btn btn-primary">Upload Announcement</button>
                                            </form>
                                            <hr>
                                ...
                                <tbody>
                                    ...
                                    foreach($announces as $announcement) { ?>
                                        <tr>
                                            ...
                                            <td>
                                            <button class="btn btn-info" data-toggle="modal" data-target="#editCourseModal"><i class="nav-icon fas fa-edit"></i> </button>
                                                <button class="btn btn-danger"><a href="process.php?coz_del"><i class="nav-icon fas fa-trash"></i></a></button>
                                            </td>
                                        </tr>
                                      <?php  } ?>
                                </tbody>
